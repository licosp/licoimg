...
This document serves as an index for all agent rules and guidelines defined in this repository.
...
- [Commit Messages](development/commit.md)
...
- [Coding Conventions](projects/coding-conventions.md)

## Workflow
Workflows and operational procedures.
- [Conversation Logging](workflow/conversation-logging.md)
- [Enhanced Communication](workflow/enhanced-communication.md)
- [User Experience](workflow/user-experience.md)
