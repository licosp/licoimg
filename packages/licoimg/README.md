# 🖼️ Web-based Image Viewer (licoimg)
...
> **Part of [licoproj](../../README.md)** - A monorepo for web projects

---

## 🌐 Live Demo

**Experience it now**: [licosp.github.io/licoproj/licoimg](https://licosp.github.io/licoproj/licoimg/)
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/licosp/licoproj.git
   cd licoproj/packages/licoimg
   ```
